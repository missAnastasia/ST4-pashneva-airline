...
<div id="page" class="container">
    ...
    <div class="login-div" id="user-info-div">
        <form  action="controller?command=addAdminFlightCommand" autocomplete="on" method="post">
            <h3>
                <label for="flight_number" class="label-n"><fmt:message key="add_flight_admin_jsp.label.number"/></label><br>
                <input id="flight_number" name="flight_number" minlength="4" maxlength="7" required type="text" placeholder="XX-0000" pattern="^[A-Z]{2}[-][0-9]{1,4}$"/>
                <span class="form__error"><fmt:message key="validation.flight_number"/></span>
            </h3>
            <h3>
                <label for="date_time" class="label-n"><fmt:message key="add_flight_admin_jsp.label.date_time"/></label><br>
            ...
            <input type="submit" value="<fmt:message key="add_flight_admin_jsp.submit"/>"  id="flight-save-button"/>
        </form>
    </div>
</div>
