...
var loginValidityChecks = [
    ...
    },
    {
        ...
        element: document.querySelector('label[for="login"] .input-requirements li:nth-child(4)')
    },
    {
        isInvalid: function(input) {
        ...
        element: document.querySelector('label[for="login"] .input-requirements li:nth-child(5)')
    }
];
