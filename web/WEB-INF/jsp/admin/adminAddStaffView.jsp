...
<div id="page" class="container">
    ...
    <div class="login-div" id="user-info-div">
        <form  action="controller?command=addAdminStaffCommand" autocomplete="on" method="post">


            <h3>
                <label for="first_name" class="label-n"><fmt:message key="add_staff_admin_jsp.first_name"/></label><br>
                <input id="first_name" name="first_name" minlength="1" maxlength="45" required type="text" placeholder="Xxx" pattern="[a-zA-Z\u0430-\u044f\u0410-\u042f\u0401\u0451]+"/>
            ...
            <h3>
                <label for="second_name" class="label-n"><fmt:message key="add_staff_admin_jsp.second_name"/></label><br>
                <input id="second_name" name="second_name" minlength="1" maxlength="45" required type="text" placeholder="Xxx" pattern="[a-zA-Z\u0430-\u044f\u0410-\u042f\u0401\u0451]+"/>
            ...
            <h3>
                <label for="login" class="label-n"><fmt:message key="add_staff_admin_jsp.login"/></label><br>
            ...
            <h3>
                <label for="password" class="label-n"><fmt:message key="add_staff_admin_jsp.password"/></label><br>
            ...
            <input type="submit" value="<fmt:message key="add_staff_admin_jsp.submit"/>"  id="staff-save-button"/>
        </form>
    </div>
</div>
