...
<div id="menu" class="container">
    <ul>
        <li class="current_page_item"><a href="${pageContext.request.contextPath}/redirect?command=getAdminFlightsPageCommand" accesskey="1" title=""><fmt:message key="menu.admin.flights"/></a></li>
