...
<html>
<c:set var="title" value="Edit Request Info" />
...
<div id="page" class="container">
    ...
    <div class="login-div" id="user-info-div">
        <form  action="controller?command=changeDispatcherRequestMessageCommand" autocomplete="on" method="post">
            <h3>
            ...
            <input type="submit" value="<fmt:message key="edit_request_dispatcher_jsp.submit"/>"/>
